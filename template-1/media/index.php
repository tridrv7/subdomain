...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="100">
        ...
        <div class="col-12">
          ...
          <div class="row justify-content-center">
            <div class="col-md-7 text-center">
              <h2 class="heading" data-aos="fade-up" data-aos-delay="0">Media Digital</h2>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <?php
      ...
      $query = "SELECT * FROM pub_socials WHERE _active=1 AND cat=003 ORDER BY _cre_date DESC LIMIT $limit_start, $limit";
      ...
      <div class="col-lg-4 col-12 mb-4">
        <a href=" <?= $url?>" data-fancybox class="video-wrap">
          ...
          <img src="https://img.youtube.com/vi/<?= $videoId?>/hqdefault.jpg" class="video-cover rounded-lg"/>
        </a>
      </div>
      <?php } ?>
