        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $('#_table tbody').on( 'click', '.getUbah', function (){
					...
					$('#_mAttr').html('<input type="hidden" class="form-control" id="agnd_id" name="agnd_id" autocomplete="off" value="'+agnd_id+'"><input type="hidden" class="form-control" id="ka_id" name="ka_id" value="<?=$_REQUEST['ka']?>" autocomplete="off">');
					$("#_mForm").attr("_act","2");
					...
					$.ajax({
						...
						data : {agnd_id:agnd_id,ka_id:<?=$_REQUEST['ka']?>},
						dataType : "JSON",
						success: function(result){
